...
public class Cube {
	...
	public void draw(float[] projection, float[] view, float[] model, ShaderHandles handles) {
		...
		GLES20.glEnableVertexAttribArray(handles.tangentHandle);
		GLES20.glVertexAttribPointer(handles.tangentHandle, 3, GLES20.GL_FLOAT, false,	0, 0);

		GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
		GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, handles.mTextureDataHandle.get(0));
		GLES20.glUniform1i(handles.mTextureUniformHandle.get(0), 0);
		
		GLES20.glActiveTexture(GLES20.GL_TEXTURE1);
		GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, handles.mTextureDataHandle.get(1));
		GLES20.glUniform1i(handles.mTextureUniformHandle.get(1),1);
		
		// texture
		GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, texCoordsBufferIdx);
		GLES20.glEnableVertexAttribArray(handles.mTextureCoordinateHandle);
		GLES20.glVertexAttribPointer(handles.mTextureCoordinateHandle, 2,	GLES20.GL_FLOAT, false, 0, 0);

		// send uniforms
		GLES20.glUniformMatrix4fv(handles.projectionHandle, 1, false, projection, 0);
		GLES20.glUniformMatrix4fv(handles.viewHandle, 1, false, view, 0);
		GLES20.glUniformMatrix4fv(handles.modelHandle, 1, false, model, 0);
	...
	public void drawPlain(float[] projection, float[] view, float[] model, ShaderHandles handles) {
